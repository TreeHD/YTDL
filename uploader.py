...
async def upload_video_streaming(bot_token, api_url, chat_id, file_path, caption="", reply_markup=None):
...
async def upload_audio_streaming(bot_token, api_url, chat_id, file_path, title="", caption=""):
